...
$SHOW_AP_TELEPHONE = "Yes"; // Yes or No - for AP to show additional telephone number and email on invoice at end o fship to
...
if ($SHOW_AP_TELEPHONE == "Yes") {
                                    echo "<tr> <td class='main-ship-name-small'>" . '<br> <br>' . $telephone_heading . $order->customer['telephone'] . "</td> </tr>";
                                    echo "<tr> <td class='main-ship-name-small'>" . $email_heading . $order->customer['email_address'] . "</td> </tr>";
                                }
                                } else {
                                    echo 'PICKUP' . '<br>';
                                }
