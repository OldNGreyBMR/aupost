...
/*  if (BMHDEBUG2 == "Yes") {  // outputs on admin | modules | shipping page
    ...
    echo ' <br>ln80 MODE= ' . AUPOST_MODE . ' //$aupost_url_string = ' .$aupost_url_string . ' aupost_url_apiKey= ' . $aupost_url_apiKey ;
} 
*/
    ...
    function quote($method = '')
    {
       ...
       // Check girth
        ...
        if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes" ) && (BMHDEBUG2 == "Yes")) { 
            echo "<table class='aupost-debug'><tr><td><b>auPost - Server Returned BMHDEBUG2 ln748:</b><br>" . $qu . "</td></tr></table> " ; 
        }  //eof debug
        ...
        foreach($xml as $foo => $bar) {    
            ...
            if (( MODULE_SHIPPING_AUPOST_DEBUG == "Yes" ) && (BMHDEBUG1 == "Yes"))  { 
                ...
                echo "ln 775 ID= $id  DESC= $description COST= $cost inc" ; 
                echo "</td></tr></table>" ; 
            ...
            switch ($id) {
                ...
                case  "AUSPARCELEXPRESS" ;
                    ...
                    if ( in_array("Express Parcel +sig", $this->allowed_methods) ) {
                        $optioncode = 'AUS_SERVICE_OPTION_SIGNATURE_ON_DELIVERY';
                        $optionservicecode = ($xml->service[$i]->code);  // get api code for this option
                        $suboptioncode = '';
                ...
                case  "AUS_PARCEL_EXPRESS_SATCHEL_1KG" ;
                case  "AUSPARCELEXPRESSSATCHEL1KG" ;
                case  "AUSPARCELEXPRESSSATCHEL500G";        // superceded by AUSPARCELEXPRESSSATCHELSMALL 
                case  "AUS_PARCEL_REGULAR_SATCHEL_5KG" ;    // superceded by 
                case  "AUSPARCELREGULARSATCHEL5KG" ;        // superceded by 
                case  "AUS_PARCEL_REGULAR_SATCHEL_3KG" ;    // superceded by AUSPARCELREGULARSATCHELLARGE
                ...
                case  "AUS_PARCEL_REGULAR_PACKAGE_SMALL";   // This is cheaper but requires extra purchase of Aus Post packaging
                case  "AUSPARCELREGULARPACKAGESMALL";       // 
    ...
    { 
        ...
        if ((in_array($allowed_option, $this->allowed_methods))) {
           ...
           // } //BMH DEBUG mask for testing 
            ...
            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes" ) && (BMHDEBUG1 == "Yes") && (BMHDEBUG2 == "Yes")) {
                    echo "<p class=\"aupost-debug\"><strong>>> Server Returned BMHDEBUG1+2 ln1154 options<< </strong> <br> <textarea> ";
    ...
    // BMH bof LETTERS
        ...
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added)
             ...
             'MODULE_SHIPPING_AUPOST_LETTER_HANDLING', '0.00', 'Handling Fee for Standard letters.', '6', '13', now())"
        );
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added)
             VALUES ('Handling Fee - Priority Letters',
             'MODULE_SHIPPING_AUPOST_LETTER_PRIORITY_HANDLING', '0.00', 'Handling Fee for Priority letters.', '6', '13', now())"
        );    
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added)
             VALUES ('Handling Fee - Express Letters',
             'MODULE_SHIPPING_AUPOST_LETTER_EXPRESS_HANDLING', '0.00', 'Handling Fee for Express letters.', '6', '13', now())"
        );    
    // BMH eof LETTERS
    
    // PARCELS
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added)
            VALUES ('Shipping Methods for Australia', 'MODULE_SHIPPING_AUPOST_TYPES1', 'Regular Parcel, Regular Parcel +sig, Registered Parcel, Express Parcel, Prepaid Satchel, Prepaid Express Satchel',
