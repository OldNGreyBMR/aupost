 ...
 $Id: aupost.php,v2.4 April 2022
  ...
  BMH 2022-02-13    line 23 declare constants
      ...
      2022-04-01    rechecked all codes returned from Aus Post
                    separated out 2nd level debug WITH Constant BMHDEBUG
*/
...
define('BMHDEBUG',"No"); // BMH 2nd level debug to display all returned data from Aus Post
...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes" ) && (BMHDEBUG == "Yes")) { echo "<table><tr><td>auPost - Server Returned:<br>" . $qu . "</td></tr></table>" ; }
...
//  loop through the quotes retrieved //
    ...
    if (( MODULE_SHIPPING_AUPOST_DEBUG == "Yes" ) && (BMHDEBUG == "Yes"))  { echo "<table><tr><td>" ; echo "ID= $id COST= $cost DESC= $description" ; echo "</td></tr></table>" ; } // BMH 2nd level debug
...
function install()
{
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) 
        VALUES ('Enable this module?', 'MODULE_SHIPPING_AUPOST_STATUS', 'True', 'Enable this Module', '6', '1', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");          $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Auspost API Key:', 'MODULE_SHIPPING_AUPOST_AUTHKEY', '', 'To use this module, you must obtain a 36 digit API Key from the <a href=\"https:\\developers.auspost.com.au\" target=\"_blank\">Auspost Development Centre</a>', '6', '2', now())");
    ...
    $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added)
        VALUES ('Shipping Methods for Australia', 'MODULE_SHIPPING_AUPOST_TYPES1', 'Regular Parcel, Registered Parcel, Express Parcel, , Prepaid Satchel, Prepaid Express Satchel, Express Post Platinum Parcel, Express Post Platinum Satchel',
