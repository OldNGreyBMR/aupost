 ...
 * @version $Id: oldngrey 2026 June 09 Modified in AuPost plugin v3.0.0 $
 */
// OldNGrey BMH 2024-12-29 compatibility with Auspost; Tax Invoice Title "TITLE_INVOICE";
//          check IMAGE_ON_INVOICE_IMAGE_SHOW to switch images
//          check address for pickup
// 2026-04-13 changes for Aus Post 2026-05-31 change requiring telephone and email for every parcel lodgement
// v3.0.0 included in plugins distribution; hr css change to force to print; fold line selected by switch; css loaded from plugin /admin/includes/css/
...
$pickup = false;        // ---- initialize variable
$show_customer = false;
...
<body>
    ...
    if (empty($order->info)) {
        ...
        <div class="container">
            ...
            <div> <!-- replace php call to zen_draw_separator to reduce height with display block and allow custom class-->
                <?php //echo zen_draw_separator('pixel_trans.gif', '100%', '1');
                    echo '<img src="images/pixel_black.gif" alt="divider" class="custom-hr-sep">';
                    ?>
            </div>
                ...
                <tr>
                    <td class="td-lh">
                        <table class="address_table"> <!-- BMH added class -->
                            <tr>
                                <td class="main-address1"><b><?php echo ENTRY_SOLD_TO; ?></b></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="main-address1"> <?php echo zen_draw_separator('pixel_trans.gif', '1', '2'); ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="main-address1">
            ...
            if ($SHOW_AP_FOLDLINE == "Yes") {
                // '<!--  dashed line for folding invoice --> '
            ...
            if ($show_customer == true) {
                ...
                <table>
                    ...
                    <tr>
                        <td class="main-address1" colspan="2">
                ...
                <thead>
                    <tr class="dataTableHeadingRow">
                        ...
                        <th class="dataTableHeadingContent text-right">
                            <?php echo ($show_including_tax) ? TABLE_HEADING_PRICE_EXCLUDING_TAX : TABLE_HEADING_PRICE; ?>
                        </th>
                        <?php if ($show_including_tax) { ?>
                            <th class="dataTableHeadingContent text-right"><?php echo TABLE_HEADING_PRICE_INCLUDING_TAX; ?></th>
                        <?php } ?>
                        <th class="dataTableHeadingContent text-right">
                            <?php echo ($show_including_tax) ? TABLE_HEADING_TOTAL_EXCLUDING_TAX : TABLE_HEADING_TOTAL; ?>
                        </th>
                        <?php if ($show_including_tax) { ?>
            ...
            <table class="table">
                ...
                for ($i = 0, $n = sizeof($order->totals); $i < $n; $i++) {
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td class="text-right <?php echo str_replace('_', '-', $order->totals[$i]['class']); ?>-Text">
                            <?php echo $order->totals[$i]['title']; ?>
                        </td>
                        <td class="text-right <?php echo str_replace('_', '-', $order->totals[$i]['class']); ?>-Amount">
