...
/*
 * $Id:   overseasaupost.php, v3.0.1 July 2026
...
class aupostoverseas extends base
{
    ...
    public function __construct()
    {
       ...
       $this->tax_class_int = MODULE_SHIPPING_OVERSEASAUPOST_TAX_CLASS;
        //$this->tax_class = STORE_PRODUCT_TAX_CLASS;
        $this->tax_basis = MODULE_SHIPPING_OVERSEASAUPOST_TAX_BASIS;
        //$this->tax_basis =STORE_PRODUCT_TAX_BASIS;
        ...
        // $this->tax_class_int = defined('MODULE_SHIPPING_OVERSEASAUPOST_TAX_CLASS') && MODULE_SHIPPING_OVERSEASAUPOST_TAX_CLASS;   // $this->tax_basis = 'Shipping' ;    // It'll always work this way, regardless of any global settings
...
//auspost API
    ...
    function get_auspost_api_int($url)
    {
        ...
        if (str_contains($ret ?? '', "error")) {          // Issue #48 if (str_contains($ret, "error")) {
            $this->_debug_output("n", 'ln' . __LINE__ . ' AUOS Error Occurred $ret= ' . json_decode($ret, true)['error']['errorMessage'] . ' </p> ', "");
        }
