...
/**
 * $Id:   aupost.php,v3.0.1 July 2026
 * 2026-04-17 - v3.0.0 - Conversion from XML API to JSON API
 ...
 *  2026-09-01 allow Flat Rate packaging
 */

/* version */
if (!defined('VERSION_AU')) {
    define('VERSION_AU', '3.0.2');
}

// ---- BMHDEBUG switches // WARNING DO NOT ENABLE FOR PRODUCTION
define('BMHDEBUG1', 'Yes');    // No or Yes // BMH 2nd level debug
define('BMH_P_DEBUG2', 'Yes'); // No or Yes // BMH 3nd level debug to display all returned json data from Aus Post
define('BMH_P_DEBUG3', 'Yes'); // No or Yes // BMH 4th level debug to display raw curl  returned json data from Aus Post
define('BMH_P_DEBUG4', 'Yes'); // No or Yes // BMH 5th level debug to display raw curl  returned json data from Aus Post
...
define('USE_CACHE', 'No');    // BMH disable cache // set to 'No' for testing; Using cache prevents excessive calls to AP if data not changed
...
define('CALL_FOR_BOXES', 'No'); // BMH set to Yes to call API to show boxes in checkout. Set to No to skip API call and hide boxes.
...
//if (!defined('AUPOST_URL_PROD')) { define('AUPOST_URL_PROD','digitalapi.auspost.com.au/postage-api'); } // BMH 2026-04-15
    ...
    public function quote($method = '')
    {
        ...
        */
        ...
        if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes") && (BMH_P_DEBUG3 == "Yes")) {
            $this->_debug_output("x", '<br>ln' . __LINE__ . ' x3  optimal parcel array = ', $result);
        } */
        ...
        if (MODULE_SHIPPING_AUPOST_TYPE_LETTERS <> null) //&& ($letterheightcheck <> 0)
        {
                        ...
                        case "AUSLETTEREXPRESSLARGE":
                            if ((in_array("Aust Express", $this->allowed_methods_l))) {
                                ...
                                (
                                    ...
                                    $details = $this->_handling($details, $extradetails,$currencies, $add, $aus_rate, $info);  // check if handling rates included
            ...
            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == 'Yes') && (BMH_P_DEBUG2 == "Yes")) {
                //$this->_debug_output("n", '<table class="aupost-debug"><tr><td><b>ln' . __LINE__ . ' n2 auPost - Server Returned BMH_P_DEBUG2  raw </b><br>' . $qu . '</td></tr></table> ', "");
            ...
            $maxcover = ($json['services']['service'][0]['max_extra_cover']);  // BMH cast to int

            if ((int) $ordervalue_ori > (int) $maxcover) {  // BMH cast to int
                $maxcoverexceeded = True; // set flag to indicate order value exceeds max extra cover for this option
                echo "<br>ln" . __LINE__ . " max cover exceeded flag set to true"; //BMH debug
            }
            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes") && (BMH_P_DEBUG3 == "Yes")) {
            ...
            $i = 0;  // counter
            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes") && (BMH_P_DEBUG3 == "Yes")) {
                $this->_debug_output("d", "ln" . __LINE__ . 'd3 $this->allowed_methods = <br> ', $this->allowed_methods); // BMH ** DEBUG
            }
            if (BMH_MIN_ORDER_VALUE_DEBUG == "Yes") {
                $ordervalue = $MINVALUEEXTRACOVER + 1;
            ...
            foreach ($json['services']['service'] as $foo => $bar) {
                ...
                */
                ...
                $description = "PARCEL " . (ucwords(strtolower($code))); // BMH prepend PARCEL to code in sentence case to identify as parcel and NOT a letter
            ...
            //
                ...
                switch ($id) {
                    ...
                    case "AUSPARCELREGULARSATCHELEXTRALARGE":           // Extra large
                        ...
                        if (in_array($parceltype_descriptor, $this->allowed_methods, true)) {
                            ...
                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", ' n2 ln' . __LINE__ . " " . $parceltype_descriptor . ' $maxcoverexceeded is True reset', ""); //
                                }
                            ...
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", "<br>ln" . __LINE__ . " n2 allowed option = " . $parceltype_descriptor, "");
                            }
                        ...
                        if (in_array($parceltype_descriptor . " Insured +sig", $this->allowed_methods)) {

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", ' n2 ln' . __LINE__ . ' ' . $parceltype_descriptor . ' Insured +sig $maxcoverexceeded =True NO CHANGE', ""); // ** DEBUG
                                }
                            ...
                            if ($ordervalue > $MINVALUEEXTRACOVER) {
                                ...
                                $allowed_option = $parceltype_descriptor . " Insured +sig";
                                $option_offset = 0;
                        ...
                        if (in_array($parceltype_descriptor . " +sig", $this->allowed_methods)) {

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . ' ' . $parceltype_descriptor . ' +sig $maxcoverexceeded $ordervalue reset', ""); //
                                }
                                $ordervalue = $maxcover - 1;
                            } else {
                                $ordervalue = $ordervalue_ori;
                            ...
                            $id_option = $id . str_replace("_", "", $optioncode) . str_replace("_", "", $suboptioncode);
                            $allowed_option = $parceltype_descriptor . " +sig";
                        ...
                        if (in_array($parceltype_descriptor . " Insured (no sig)", $this->allowed_methods)) {
                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . " " . $parceltype_descriptor . " Insured (no sig) maxcover exceed= " . ($maxcoverexceeded ? 'true' : 'false') . " order value = $ordervalue break ", ""); //BMH ** DEBUG
                                }
                                break;
                            } else {
                                $ordervalue = $ordervalue_ori;
                            ...
                            if ($ordervalue > $MINVALUEEXTRACOVER) {
                                ...
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("d", 'ln' . __LINE__ . ' d2 $result_secondary_options = ', $result_secondary_options); // ** DEBUG
                                }
                    ...
                    case "AUS_PARCEL_EXPRESS_SATCHEL_1KG":              // Small-Medium satchel
                    ...
                    //case "AUSPARCELEXPRESSSATCHEL5KG":                // Large satchel
                        ...
                        if ((in_array($parceltype_descriptor, $this->allowed_methods))) {
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", 'ln' . __LINE__ . ' n2 allowed option = parcel express satchel', "");
                            }

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", ' n2 ln' . __LINE__ . ' ' . $parceltype_descriptor . ' $maxcoverexceeded $ordervalue reset', ""); // ** DEBUG
                                }
                                $ordervalue = $maxcover - 1;
                            } else {
                                $ordervalue = $ordervalue_ori;
                        ...
                        if (in_array($parceltype_descriptor . " Insured +sig", $this->allowed_methods)) {
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", "<br>ln" . __LINE__ . " n2 allowed option = " . $parceltype_descriptor . " ins+sig", "");
                                $this->_debug_output("n", "<br>ln" . __LINE__ . " n2 ordervalue = ", $ordervalue);
                            }

                            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<p class="aupost-debug">ln' . __LINE__ . ' n2 ' . $parceltype_descriptor . ' $maxcoverexceeded $ordervalue reset', ""); // ** DEBUG
                            }
                            $ordervalue = $ordervalue_ori;
                            // reset if max extra cover exceeded
                        ...
                        if (in_array($parceltype_descriptor . " +sig", $this->allowed_methods)) {
                            ...
                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . ' ' . $parceltype_descriptor . ' +sig $maxcoverexceeded $ordervalue break', ""); // ** DEBUG
                                }
                                break;
                            } else {
                                $ordervalue = $ordervalue_ori;
                    ...
                    case "AUSPARCELREGULAR":                                // normal mail - own packaging
                        ...
                        if (in_array($parceltype_descriptor, $this->allowed_methods, $strict = true)) {
                            ...
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<br>ln' . __LINE__ . ' n2 allowed option = parcel regular', "");
                            }

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug">ln' . __LINE__ . ' n2 ' . $parceltype_descriptor . ' $maxcoverexceeded reset', ""); // ** DEBUG
                                }
                                $ordervalue = $maxcover - 1;
                            } else {
                                $ordervalue = $ordervalue_ori;
                        ...
                        if (in_array($parceltype_descriptor . " Insured +sig", $this->allowed_methods)) {
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<br>ln' . __LINE__ . ' n2 allowed option = parcel ' . $parceltype_descriptor . ' ins + sig', "");
                            }

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . ' ' . $parceltype_descriptor . ' Insured +sig $maxcoverexceeded NO CHANGE', ""); // ** DEBUG
                                }
                                $ordervalue = $ordervalue_ori;
                            } // reset if max extra cover exceeded
                            $ordervalue = $ordervalue_ori;
                        ...
                        if (in_array($parceltype_descriptor . " +sig", $this->allowed_methods)) {
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<br>ln' . __LINE__ . ' n2 allowed option = parcel ' . $parceltype_descriptor . ' + sig', "");
                            }

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . ' ' . $parceltype_descriptor . ' +sig $maxcoverexceeded reset', ""); //
                                }
                                $ordervalue = $maxcover - 1;
                            } else {
                                $ordervalue = $ordervalue_ori;
                    ...
                    case "AUSPARCELEXPRESS":                                // express mail - own packaging
                        ...
                        if (in_array($parceltype_descriptor . " Insured +sig", $this->allowed_methods)) {
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<br>ln' . __LINE__ . ' n2 allowed option = ' . $parceltype_descriptor . ' Insured +sig', "");
                            }

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . ' ' . $parceltype_descriptor . ' $maxcoverexceeded NO CHANGE', ""); // ** DEBUG
                                }
                                $ordervalue = $ordervalue_ori;
                            } // reset if max extra cover exceeded
                            $ordervalue = $ordervalue_ori;
                        ...
                        if (in_array($parceltype_descriptor . " +sig", $this->allowed_methods)) {
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<br>ln' . __LINE__ . ' n2 allowed option = ' . $parceltype_descriptor . ' + sig', "");
                            }
                    ...
                    case "AUSPARCELREGULARPACKAGELARGE":                    // Large
                        ...
                        if (in_array($parceltype_descriptor, $this->allowed_methods, $strict = true)) {
                            ...
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<br>ln' . __LINE__ . ' n2 allowed option = FR package regular', "");
                            }
                            ...
                            $extradetails =  "FRP"; // BMH to insert correct name into package
                            //$allowed_option = "FRP";
                            ...
                            if ((($cost > 0) && ($f == 1))) { //
                                ...
                                // BMH $details = $this->_handling($details, $currencies, $add, $aus_rate, $info);  // check if handling rates included
                                 $details = $this->_handling($details, $extradetails, $currencies, $add, $aus_rate, $info);  // check if handling rates included
                            }   // eof list option for normal operation
                            $cost = $cost / $aus_rate;
                            ...
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG4 == "Yes")) {
                                $array_dump = array('id' => "$id", 'title' => $description . " " . $details . $extradetails, 'cost' => $cost);
                                //$this->_debug_output("d", '<br>ln' . __LINE__ . 'd4 FRP $details= ', $details . $extradetails);
                                $this->_debug_output("d", '<br>ln' . __LINE__ . 'd4 FRP method= ', $array_dump);
                            }
                        }
                        ...
                        if (in_array($parceltype_descriptor . " Insured +sig", $this->allowed_methods)) {
                            ...
                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . ' Flat Rate Packaging Insured +sig $maxcoverexceeded NO CHANGE', ""); // ** DEBUG
                                }
                                $ordervalue = $ordervalue_ori;
                            } // reset if max extra cover exceeded
                            $ordervalue = $ordervalue_ori;
                    ...
                    case "AUSPARCELEXPRESSPACKAGELARGE":                // Large
                        ...
                        if (in_array($parceltype_descriptor . " Insured +sig", $this->allowed_methods, $strict = true)) {
                            if ((BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                $this->_debug_output("n", '<br>ln' . __LINE__ . ' n2 allowed option = ' . $parceltype_descriptor . ' ins + sig', "");
                            }
                            if ($ordervalue > $MINVALUEEXTRACOVER) {
                        ...
                        if (in_array($parceltype_descriptor . " +sig", $this->allowed_methods, $strict = true)) {

                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", '<p class="aupost-debug"> n2 ln' . __LINE__ . ' Prepaid ' . $parceltype_descriptor . ' Insured (no sig) $maxcoverexceeded break', ""); // ** DEBUG
                                }
                                $ordervalue = $maxcover - 1;
                            } else {
                                $ordervalue = $ordervalue_ori;
                        ...
                        if (in_array($parceltype_descriptor . " Insured (no sig)", $this->allowed_methods)) {
                            ...
                            if ($maxcoverexceeded === True) {
                                if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes")) {
                                    $this->_debug_output("n", ' n2 ln' . __LINE__ . " Prepaid " . $parceltype_descriptor . " Insured (no sig) maxcover exceed= " . ($maxcoverexceeded ? 'true' : 'false') . " order value = $ordervalue break ", ""); // ** DEBUG
                                }
                                break;
                            } else {
                                $ordervalue = $ordervalue_ori;
                    ...
                    //case "AUSPARCELREGULARSATCHEL1KG":          // still returned but superceded
            ...
            */
            ...
            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG4 == "Yes")) {
            ...
            // BMH DEBUG  RESTORE $resultarr = array_unique($resultarr, SORT_REGULAR);  // remove full-entry duplicates
            ...
            /**
             *  Change REgular Package to Flat Rate  ie the returned description to the advertised description
...
&service_code=$optionservicecode&option_code=$optioncode&suboption_code=$suboptioncode&extra_cover=$ordervalue", "");
            ...
            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMH_P_DEBUG2 == "Yes") && (BMH_P_DEBUG3 == "Yes") && (BMH_P_DEBUG4 == "Yes")) {
                $this->_debug_output("n", '<br> ln' . __LINE__ . ' n3 $qu2 = ' . $qu2, "");
                $this->_debug_output("n", '<br> ln' . __LINE__ . ' n3 $details = ' . $details, ""); // BMH DEBUG
            }

            $jsonquote_2 = ($qu2 == '') ? array() : json_decode($qu2, true); // JSON format

            if ((MODULE_SHIPPING_AUPOST_DEBUG == "Yes") && (BMHDEBUG1 == "Yes") && (BMH_P_DEBUG2 == "Yes") && (BMH_P_DEBUG3 == "Yes")) {
                $this->_debug_output("x", '<br> ln' . __LINE__ . ' x3  $allowed_option = ' . $allowed_option . ' <br> ' . 'Server Returned options :', $jsonquote_2);
            }
            ...
            if (empty($invalid_option)) {
                ...
                /**
                 * change returned description line to remove man description option
                 */
                $result_secondary_options = array("id" => $id_option, "title" => $description . ' ' . $desc_option . ' ' . $details, "cost" => $cost);

                // BMH 2026-09-01 $result_secondary_options = array("id" => $id_option, "title" =>  $desc_option . ' ' . $details, "cost" => $cost);
     ...
     * @param mixed $info
     */
    private function _handling($details, $extradetails, $currencies, $add, $aus_rate, $info)
    {
